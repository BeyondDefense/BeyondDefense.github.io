...
<div class="home-intro" markdown="0">
  ...
  <p class="home-body">We're a research group in the <a href="https://www.cs.unm.edu/">Department of Computer Science</a> at the <a href="https://www.unm.edu/">University of New Mexico</a>, building defenses against evolving attacks on VPNs, satellites, and mobile &amp; web apps through malware analysis, vulnerability research, and threat intelligence.</p> 
  <p class="home-body">Recent work has had real-world impact: our CCS 2026 study of SMS-delivered URLs — covered by <a href="https://arstechnica.com/security/2026/01/millions-of-people-imperiled-through-sign-in-links-sent-by-sms">Ars Technica</a>, <a href="https://www.helpnetsecurity.com/2026/01/23/sms-private-urls-data-exposure-study/">Help Net Security</a>, and <a href="https://www.techradar.com/pro/millions-of-smartphone-users-could-be-at-risk-from-the-sms-sign-in-url-issue-heres-what-you-need-to-look-out-for">TechRadar Pro</a> — exposed personal data across 177 online services and led 7 providers to fix the flaw, and our MVPNalyzer framework (NDSS 2026), covered by <a href="https://thehackernews.com/2026/07/study-of-281-free-android-vpn-apps.html">The Hacker News</a> and <a href="https://news.engin.umich.edu/2026/07/mobile-vpn-security-is-not-as-strong-as-advertised/">Michigan Engineering News</a>, found that free mobile VPN apps leak user data and fail at basic security promises. Also, we found a <a href="https://sparta.aerospace.org/technique/DE-0012/">novel vulnerability in spacecrafts</a>.</p>
  <p class="home-body">Our research has also caught the attention of global cybersecurity authorities. We have been spotlighted by <a href="https://cert.gov.az/en/news/sms-delivered-login-links-have-created-security-risks-for-millions-of-users-9097">Azerbaijani CERT</a>, <a href="https://ctoatncsc.substack.com/p/cto-at-ncsc-summary-week-ending-february-df7">UK National Cyber Security Centre (NCSC)</a>, and NASA IV&V.</p>
  <div class="home-ctas">
    <a class="cta-btn cta-primary" href="/team/">Meet the Team</a>
    <a class="cta-btn cta-secondary" href="/research/">Our Research</a>
  </div>
</div>

<div class="home-research-areas" markdown="0">
  <h2 class="section-heading">Research Areas</h2>
  <div class="home-area-grid home-area-grid--3">
    <a class="home-area-card" href="/publications/?topic=vpn">
      <div class="home-area-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><line x1="9" y1="12" x2="11" y2="14"/><line x1="11" y1="14" x2="15" y2="10"/></svg>
      </div>
      <span>VPN Security</span>
    </a>
    <a class="home-area-card" href="/publications/?topic=space">
      <div class="home-area-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="2"/><path d="M12 2a10 10 0 0 1 10 10"/><path d="M12 2a10 10 0 0 0-10 10"/><line x1="2" y1="12" x2="5" y2="12"/><line x1="19" y1="12" x2="22" y2="12"/><path d="M15 12l5 5M9 12l-5 5"/></svg>
      </div>
      <span>Space Systems</span>
    </a>
    <a class="home-area-card" href="/publications/?topic=web">
      <div class="home-area-icon">
